...
class Pred_endecoder(nn.Module):
    ...
    def forward(self, x, audio_feature=None, mixup_lambda=None, is_training=False):
        ...
        return pred, feature_map_list, a_fea_list, adapter_index_dict, adapter_probs_dict, total_load_balancing_loss, visual_feature, audio_feature_reshape, audio_feature
