...
class MoEAdapter(nn.Module):
    ...
    def forward(self, x, vis_token=None, is_training=True):
        ...
        # final_expert_output shape:  torch.Size([10, 96, 4096, 1])
...
class Pred_endecoder(nn.Module):
    ...
    def forward(self, x, audio_feature=None, mixup_lambda=None, is_training=True):
        ...
        return pred, feature_map_list, a_fea_list, adapter_index_dict, adapter_probs_dict, total_load_balancing_loss
