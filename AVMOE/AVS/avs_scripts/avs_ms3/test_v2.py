...
if __name__ == "__main__":
    ...
    # Test data
    split = 'test'
    test_dataset = MS3Dataset(split, args)
    ...
    with torch.no_grad():
        for n_iter, batch_data in enumerate(test_dataloader):
            imgs, audio_spec, audio, mask, wave, video_name_list = batch_data # [bs, 5, 3, 224, 224], [bs, 5, 1, 96, 64], [bs, 1, 1, 224, 224]
            ...
            output, _, _, adapter_index_dict, adapter_probs, _= model(imgs, wave, mixup_lambda=mixup_lambda, is_training=False) # [5, 1, 224, 224] = [bs=1 * T=5, 1, 224, 224]
